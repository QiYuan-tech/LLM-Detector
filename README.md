...
## <img src="assets/logo.png" style="vertical-align: middle; width: 45px;"> LLM-Detector: Using large language models with Supervised Fine-Tuning for AI-Generated Text Detection 
